Shader "Custom/SDFTest"
{
	...
	SubShader{
		Pass {
			...
			// constant definition
			#define MAX_MARCHING_STEPS 255// Maximum number of raymarching
			...
			float sdScene(float3 p) {
				...
				return opSmoothUnion(d1, d2, 0.5) * 0.8;// Take the smooth intersection, *0.8 represents the compensation of the uniform scale in the first step
			}
